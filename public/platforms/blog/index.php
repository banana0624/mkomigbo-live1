...
/**
 * /public/platforms/blog/index.php
...
$page_desc  = 'The Blog platform is coming soon.';
...
/* Coming-soon pages should be 200 (not 404) */
...
<main class="container mk-page">
  ...
  <section class="pf-section">
    ...
    <section class="pf-grid">
      <article class="pf-card pf-card--blog" data-platform="blog">
        <div class="pf-card__bar" aria-hidden="true"></div>
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">B</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Editorial posts</h3>
              <p class="pf-card__desc">Featured writings tied to Subjects, People, and events.</p>
            </div>
          </div>
          <div class="pf-card__meta">
            <span class="pf-pill">Planned</span>
            <span class="pf-pill">Curated</span>
          </div>
        </div>
      </article>
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              ...
              <p class="pf-card__desc">Every post can connect directly to Subjects and Pages.</p>
            </div>
          </div>
          <div class="pf-card__meta">
            <span class="pf-pill">Planned</span>
      ...
      <article class="pf-card pf-card--gallery" data-platform="gallery">
        <div class="pf-card__bar" aria-hidden="true"></div>
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">G</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Media-ready</h3>
              <p class="pf-card__desc">Support for images, documents, audio, and embedded video.</p>
            </div>
          </div>
          <div class="pf-card__meta">
            <span class="pf-pill">Planned</span>
            <span class="pf-pill">Attachments</span>
          </div>
        </div>
      </article>
    </section>
