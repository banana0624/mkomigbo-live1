...
$page_desc  = 'Posts is coming soon: short-form updates, featured notes, and announcements.';
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        Short, structured updates that can be linked back to Subjects and references.
      </p>
      ...
      <article class="pf-card" style="--pf-accent:#2F3A4A;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">P</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Short posts</h3>
              <p class="pf-card__desc mk-muted">Updates, notes, and highlights.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Fast</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#2F4A43;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Subject links</h3>
              <p class="pf-card__desc mk-muted">Attach posts directly to Subjects and Pages.</p>
            </div>
          </div>
      ...
      <article class="pf-card" style="--pf-accent:#4A3F2F;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">References</h3>
              <p class="pf-card__desc mk-muted">Optional sources and attachments per post.</p>
            </div>
          </div>
