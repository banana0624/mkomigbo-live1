...
/**
 * /public/platforms/reel/index.php
...
$page_desc  = 'Reels is coming soon: short-form video and curated clips with references.';
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        Short video clips, highlights, and curated reels with references and context.
      </p>
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Clips</h3>
              <p class="pf-card__desc mk-muted">Short highlights and quick explainers.</p>
            </div>
          </div>
      ...
      <article class="pf-card" style="--pf-accent:#2F4A43;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Linked context</h3>
              <p class="pf-card__desc mk-muted">Each reel can link to Subjects and sources.</p>
            </div>
          </div>
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              ...
              <p class="pf-card__desc mk-muted">Credit and provenance with optional attachments.</p>
            </div>
          </div>
