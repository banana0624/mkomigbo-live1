...
$page_desc  = 'Communities is coming soon: collaboration, discussion spaces, and contributor-led circles.';
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        A space for structured collaboration: circles, projects, discussions, and contributor-led learning.
      </p>
  ...
  <section class="pf-section">
    ...
    <section class="pf-grid">
      <article class="pf-card" style="--pf-accent:#2F4A5A;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">C</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Circles</h3>
              <p class="pf-card__desc mk-muted">Topic-based groups tied to Subjects and projects.</p>
            </div>
          </div>
      ...
      <article class="pf-card" style="--pf-accent:#2F3A4A;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">Q&amp;A</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Questions and answers</h3>
              <p class="pf-card__desc mk-muted">Ask, cite sources, and build verified answers together.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Moderated</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#4A3F2F;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">R</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Research threads</h3>
              <p class="pf-card__desc mk-muted">Long-running investigations with attachments and references.</p>
            </div>
          </div>
