...
/**
 * /public/platforms/knowledge_index/index.php
...
$page_desc  = 'Knowledge Index is coming soon: cross-subject discovery by tags, themes, and timelines.';
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        Cross-subject navigation by tag, theme, timeline, people, and sources.
      </p>
  ...
  <section class="pf-section">
    ...
    <section class="pf-grid">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Unified discovery</h3>
              <p class="pf-card__desc mk-muted">Search and browse across Subjects and Pages.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Index</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#2F3A4A;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">TAG</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Tags and themes</h3>
              <p class="pf-card__desc mk-muted">Cluster content by themes, places, and eras.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Tags</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#4A3F2F;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">T</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Timelines</h3>
              <p class="pf-card__desc mk-muted">Navigate by chronology and linked events.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Timeline</span></div>
        </div>
      </article>
    </section>
  </section>
