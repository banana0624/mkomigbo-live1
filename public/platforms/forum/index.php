...
/**
 * /public/platforms/forum/index.php
...
$page_desc  = 'Forum is coming soon: structured discussion and Q&A across topics.';
...
<main class="container mk-page">
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        A moderated space for discussion, Q&amp;A, and collaborative learning tied to Subjects.
      </p>
  ...
  <section class="pf-section">
    ...
    <section class="pf-grid">
      <article class="pf-card" style="--pf-accent:#2F4A5A;">
        <div class="pf-card__bar"></div>
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">F</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Topic boards</h3>
              <p class="pf-card__desc mk-muted">Board structure aligned to Subjects and themes.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Organized</span></div>
        </div>
      </article>

      <article class="pf-card" style="--pf-accent:#3C2F4A;">
        <div class="pf-card__bar"></div>
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">?</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Q&amp;A</h3>
              <p class="pf-card__desc mk-muted">Answers can be cited and linked to source material.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Citations</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#4A3F2F;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Media-aware</h3>
              <p class="pf-card__desc mk-muted">Support for images, documents, and referenced links.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Attachments</span></div>
        </div>
      </article>
    </section>
  </section>
