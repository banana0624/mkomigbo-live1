...
$page_desc  = 'Threads is coming soon: long-form discussions and research trails with attachments.';
  ...
  <header class="mk-hero mk-hero--compact">
    ...
    <div class="mk-hero__inner">
      ...
      <p class="mk-muted mk-lede">
        Deep discussions and research trails with structured references and attachments.
      </p>
  ...
  <section class="pf-section">
    ...
    <section class="pf-grid">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Long-form threads</h3>
              <p class="pf-card__desc mk-muted">Organize complex topics into readable trails.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Long-form</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#4A3F2F;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            <div class="pf-icon" aria-hidden="true">DOC</div>
            <div class="pf-card__text">
              <h3 class="pf-card__title">Attachments</h3>
              <p class="pf-card__desc mk-muted">Documents, images, audio/video references per thread.</p>
            </div>
          </div>
          <div class="pf-card__meta"><span class="pf-pill">Planned</span><span class="pf-pill">Media</span></div>
        </div>
      </article>
      ...
      <article class="pf-card" style="--pf-accent:#2F4A43;">
        ...
        <div class="pf-card__body">
          <div class="pf-card__top">
            ...
            <div class="pf-card__text">
              <h3 class="pf-card__title">Source trails</h3>
              <p class="pf-card__desc mk-muted">Citations and provenance as first-class metadata.</p>
            </div>
          </div>
