...
/**
 * /public/subjects/media.php  (ALIAS SHIM)
 * Back-compat endpoint. Forwards to /public/media.php.
 *
 * Accepts legacy query:
 *   ?subject=&page=&file=&dl=
 *   ?s=&p=&f=&in=
 *
 * Forces:
...
/* Hand off to central endpoint (same request, same output) */
