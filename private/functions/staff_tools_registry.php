...
if (!function_exists('mk_staff_tools_registry')) {
  ...
  function mk_staff_tools_registry(): array
  {
    ...
    /* AWAG Tools */
    $tools[] = ["key"=>"awag/feedback","title"=>"AWAG Feedback Admin","desc"=>"Review community corrections and feedback for AWAG calendars.","group"=>"AWAG","min_role"=>"admin","rel_path"=>"","abs_path"=>"","mutating"=>false,"url"=>"/awag/admin.php"];
    $tools[] = ["key"=>"awag/view","title"=>"AWAG Public Landing","desc"=>"View the AWAG Africa Weekly Activities Guide landing page.","group"=>"AWAG","min_role"=>"admin","rel_path"=>"","abs_path"=>"","mutating"=>false,"url"=>"/awag/"];
